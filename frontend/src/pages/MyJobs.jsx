...
const MyJobs = () => {
    ...
    return (
        <div className='max-w-screen-2xl container mx-auto cl:px-24 px-4'>
            <div className='my-jobs-container'>
                ...
                <div className='search-box p-2 text-center mb-2'>
                    ...
                    <button className='bg-blue text-white font-semibold px-8 py-2 rounded-r-sm mb-4' onClick={handleSearch}>Search</button>
                </div>
            </div>
            ...
            <section className="py-1 bg-blueGray-50">
                ...
                <div className='flex justify-center text-black space-x-8 mb-8'>
                    {
                        currentPage > 1 && (
                            <button className='hover:underline' onClick={prePage}>Previos</button>
                        )
                    }
                    {
