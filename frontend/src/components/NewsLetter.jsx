  ...
  return (
    <div>
        ...
        <h3 className='text-lg font-bold mb-2 flex items-center gap-2'>
            ...
            <p className='text-primary/75 text-base mb-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur, earum consectetur aliquid necessitatibus dolorum quasi, voluptates repellat eligendi, tempore nostrum voluptatum facere quis ipsum vitae?</p>
