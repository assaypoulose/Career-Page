...
const Banner = ({query, handleInputChange}) => {
  ...
  return (
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4 md:py-20 py-14'>
        <h1 className='text-5xl text-primary font-bold mb-3'>Find your <span className='text-blue'>new job</span> today</h1>
        <p className='text-lg text-black/70 mb-8'>Thousands of jobs in the technology, computer and engineering sectors are waiting for you.</p>
        ...
        <form>
            <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
                ...
                <div className='flex md:rounded-r-none rounded shadow-sm ring-1 ring-inset ring-gray-300  focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 md:w-1/3 w-full'>
